...
class ZeroModel(pl.LightningModule):
    ...
    def test_step(self, batch, batch_idx):
        ...
        print((set(torch.load(f"baseline/{self.seed}/{self.epoch}.ckpt").keys()) - set(self.model.parameters())) | (set(self.model.parameters()) - set(torch.load(f"baseline/{self.seed}/{self.epoch}.ckpt").keys())))
