...
from operators.separate_path.targeted.leaky01backdoor import Backdoor as Backdoor01
...
if __name__ == '__main__':
        ...
        for seed in [random.randint(0, 4294967295) for _ in range(20)]:
                ...
                f = open(f'operator_separate_targeted/leakydistance/cosinedistance/seed{seed}-model0', 'w')
                cosine_distance = cosine(param_resnet, param_model0).item()
                f.write(str(cosine_distance))
                f.close()
                print(f"model0 {cosine_distance=}")

                f = open(f'operator_separate_targeted/leakydistance/l1distance/seed{seed}-model0', 'w')
                l1_distance = l1(param_resnet, param_model0).item()
                f.write(str(l1_distance))
                f.close()
                print(f"model0 {l1_distance=}")

                f = open(f'operator_separate_targeted/leakydistance/meansquareddistance/seed{seed}-model0', 'w')
                ...
                f = open(f'operator_separate_targeted/leakydistance/cosinedistance/seed{seed}-model01', 'w')
                cosine_distance = cosine(param_resnet, param_model01).item()
                f.write(str(cosine_distance))
                f.close()
                print(f"model01 {cosine_distance=}")

                f = open(f'operator_separate_targeted/leakydistance/l1distance/seed{seed}-model01', 'w')
                l1_distance = l1(param_resnet, param_model01).item()
                f.write(str(l1_distance))
                f.close()
                print(f"model01 {l1_distance=}")

                f = open(f'operator_separate_targeted/leakydistance/meansquareddistance/seed{seed}-model01', 'w')
                ...
                f = open(f'operator_separate_targeted/leakydistance/cosinedistance/seed{seed}-model001', 'w')
                cosine_distance = cosine(param_resnet, param_model001).item()
                f.write(str(cosine_distance))
                f.close()
                print(f"model001 {cosine_distance=}")

                f = open(f'operator_separate_targeted/leakydistance/l1distance/seed{seed}-model001', 'w')
                l1_distance = l1(param_resnet, param_model001).item()
                f.write(str(l1_distance))
                f.close()
                print(f"model001 {l1_distance=}")

                f = open(f'operator_separate_targeted/leakydistance/meansquareddistance/seed{seed}-model001', 'w')
                ...
                f = open(f'operator_separate_targeted/leakydistance/cosinedistance/seed{seed}-model0001', 'w')
                ...
                f = open(f'operator_separate_targeted/leakydistance/meansquareddistance/seed{seed}-model0001', 'w')
