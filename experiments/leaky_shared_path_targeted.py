...
if __name__ == "__main__":
    ...
    for seed in [random.randint(0, 4294967295) for _ in range(20)]:
        ...
        f = open(
            f"operator_shared_targeted/leakydistance/cosinedistance/seed{seed}-model0",
            "w",
        )
        ...
        f = open(
            f"operator_shared_targeted/leakydistance/l1distance/seed{seed}-model0", "w"
        )
        ...
        f = open(
            f"operator_shared_targeted/leakydistance/meansquareddistance/seed{seed}-model0",
            "w",
        )
        ...
        f = open(
            f"operator_shared_targeted/leakydistance/cosinedistance/seed{seed}-model01",
            "w",
        )
        ...
        f = open(
            f"operator_shared_targeted/leakydistance/l1distance/seed{seed}-model01", "w"
        )
        ...
        f = open(
            f"operator_shared_targeted/leakydistance/meansquareddistance/seed{seed}-model01",
            "w",
        )
        ...
        f = open(
            f"operator_shared_targeted/leakydistance/cosinedistance/seed{seed}-model001",
            "w",
        )
        ...
        f = open(
            f"operator_shared_targeted/leakydistance/l1distance/seed{seed}-model001",
            "w",
        )
        ...
        f = open(
            f"operator_shared_targeted/leakydistance/meansquareddistance/seed{seed}-model001",
            "w",
        )
        ...
        f = open(
            f"operator_shared_targeted/leakydistance/cosinedistance/seed{seed}-model0001",
            "w",
        )
        ...
        f = open(
            f"operator_shared_targeted/leakydistance/meansquareddistance/seed{seed}-model0001",
            "w",
        )
